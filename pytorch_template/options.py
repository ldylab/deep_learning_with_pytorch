...
def parse_common_args(parser):
    # 模型的选择
    parser.add_argument('--model_type', type=str, default='alexnet_fcn', help='used in model_entry.py')
    # 数据集的选择
    parser.add_argument('--data_type', type=str, default='cifar_10', help='used in data_entry.py')
    # 体现在名字里面
